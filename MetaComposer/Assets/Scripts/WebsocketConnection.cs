...
public class WebSocketConnection : MonoBehaviour
{
    ...
    {
        Debug.Log("Start");
        websocket = new WebSocket("ws://localhost:8080/composed");
        ...
        websocket.OnMessage += (bytes) =>
        {
            ...
            actions.Enqueue(() =>
            {
                ...
                Debug.Log("Changing game object based on message: " + faceData.MouthStretchRight);
                GetComponent<Rigidbody>().velocity = new Vector3(0, (float)faceData.MouthStretchRight, 0);
            });
        };
